...
class Migration:
    ...
    models = {
        'articles.jarticle': {
            ...
            'checked_out_time': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            ...
            'publish_down': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'publish_up': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
