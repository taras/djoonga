...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserReference'
        db.create_table(u'djoonga_jos_user_reference', (
            ('id', orm['users.UserReference:id']),
            ('django', orm['users.UserReference:django']),
            ('joomla', orm['users.UserReference:joomla']),
        ))
        db.send_create_signal('users', ['UserReference'])
        
        # Creating unique_together for [django, joomla] on UserReference.
        db.create_unique(u'djoonga_jos_user_reference', ['django_id', 'joomla_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [django, joomla] on UserReference.
        db.delete_unique(u'djoonga_jos_user_reference', ['django_id', 'joomla_id'])
        
        # Deleting model 'UserReference'
        db.delete_table(u'djoonga_jos_user_reference')
